...
var MySQL = (function (_super) {
    ...
    MySQL.prototype.connect = function (force) {
        var _this = this;
    ...
    MySQL.prototype.query = function (query) {
        ...
        return new Promise(function (resolve, reject) {
            _this.connection.query(query, function (err, result) {
                if (err && err.fatal) {
                    _this.close().then(function () { return _this.connect(true).then(function () { return reject(err); }); }).catch(function () { return reject(err); });
                }
                else if (err) {
                    return reject(err);
                }
    ...
    MySQL.prototype.close = function (destroy) {
        var _this = this;
